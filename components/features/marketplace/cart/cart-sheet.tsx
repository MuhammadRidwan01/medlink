      ...
      <div className="flex h-full flex-col">
                ...
                <div className="flex w-full flex-col gap-2">
                  <header className="flex items-start justify-between gap-2">
                    ...
                    <button
                      ...
                      className="tap-target rounded-full border border-border/60 bg-muted/30 p-1.5 text-muted-foreground transition hover:bg-muted/50"
                  ...
                  <div className="flex items-center justify-between gap-2">
                    <div className="inline-flex items-center gap-2 rounded-button border border-border/60 bg-background px-2 py-1">
                      <button
                        ...
                        className="tap-target rounded-full border border-border/60 p-1 text-muted-foreground transition hover:bg-muted/40"
        ...
        <footer className="border-t border-border/60 bg-muted/20 px-6 py-4">
          ...
          <button
            ...
            className={cn(
              "tap-target mt-3 inline-flex w-full items-center justify-center rounded-button bg-primary-gradient px-4 py-2 text-sm font-semibold text-primary-foreground shadow-md transition hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
