...
type ConsultationFeedbackPageClientProps = {
  consultationId: string;
};

export function ConsultationFeedbackPageClient({
  consultationId,
}: ConsultationFeedbackPageClientProps) {
        ...
        <div className="space-y-4">
          <section className="space-y-2">
            ...
            <RatingStars
              value={rating}
              onChange={setRating}
              ariaLabel="Rate your consultation from 1 to 5 stars"
            />
          </section>
          <section className="space-y-2">
            <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">
