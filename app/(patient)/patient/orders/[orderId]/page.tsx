...
export default function OrderDetailPage({ params }: OrderDetailPageProps) {
  ...
  const order = useMemo(
    () => MOCK_ORDERS.find((entry) => entry.id === params.orderId),
    [params.orderId],
  );
      ...
      >
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)]">
          <div className="space-y-6">
            <section className="rounded-card border border-border/60 bg-card p-4 shadow-sm">
              ...
              <div className="mt-4 grid gap-3 text-sm text-muted-foreground sm:grid-cols-2">
                <div>
                  <p className="text-xs font-semibold uppercase tracking-wide">Metode</p>
            ...
            <CourierTimeline entries={order.timeline} currentStatus={order.status} />
              ...
              <section className="space-y-3 rounded-card border border-border/60 bg-card p-4 shadow-sm">
                <header className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-2">
                    ...
                    <h2 className="text-sm font-semibold text-foreground">Pelacakan kurir</h2>
                  </div>
          ...
          <aside className="space-y-6">
            ...
            <section className="space-y-3 rounded-card border border-border/60 bg-card p-4 shadow-sm">
              <h2 className="text-sm font-semibold text-foreground">Ringkasan Pembayaran</h2>
